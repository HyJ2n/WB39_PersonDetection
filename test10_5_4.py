...
class FaceRecognizer:
    ...
    def recognize_faces(self, frame, frame_number, output_dir, gender_model):
...
def process_video(video_path, output_dir, yolo_model_path, gender_model_path, target_fps=10):
    ...
    while True:
        ...
        frame = recognizer.recognize_faces(frame, frame_number, output_dir, gender_model)
...
if __name__ == "__main__":
    ...
    process_video(video_path, output_directory, yolo_model_path, gender_model_path)
